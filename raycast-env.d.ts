...
declare namespace Preferences {
  /** Preferences accessible in the `search-extensions` command */
  export type SearchExtensions = ExtensionPreferences & {}
  /** Preferences accessible in the `search-docs` command */
  export type SearchDocs = ExtensionPreferences & {}
}

declare namespace Arguments {
  /** Arguments passed to the `search-extensions` command */
